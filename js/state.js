...
export const VISIT_FALLBACK_EASTER_EGGS = [
  ...
  },
  {
    ...
    effects: { intimacy: 3, mood: 1 },
    tags: ['soft', 'bond', 'outgoing'],
  },
  {
    id: 'friendly_following',
    text: '不知不觉间，它们开始一前一后地跟着对方走，像已经习惯彼此陪在身边。',
    effects: { intimacy: 3, mood: 1 },
    tags: ['bond', 'incoming', 'soft'],
  },
  {
    id: 'double_discovery',
    text: '它们同时发现了一个超有趣的小细节，兴奋得几乎要抢着告诉对方。',
    effects: { intimacy: 2, mood: 3 },
    tags: ['surprise', 'playful', 'incoming'],
  },
  {
    id: 'warm_return',
    text: '做客结束后，它把今天积攒的小开心一起带回来了，连脚步都轻快了些。',
    effects: { intimacy: 2, mood: 2 },
    tags: ['focus', 'outgoing', 'cozy'],
  },
  {
    id: 'mini_teamwork',
    text: '它们配合着完成了一个小小的合作游戏，最后还彼此得意地看了一眼。',
    effects: { intimacy: 3, mood: 2 },
    tags: ['toy', 'bond', 'playful'],
  },
  {
    id: 'soft_nuzzle',
    text: '聊天聊到高兴的时候，它们轻轻蹭了蹭彼此，像在交换一点安心感。',
    effects: { intimacy: 3, mood: 1 },
    tags: ['soft', 'bond', 'incoming'],
  },
  {
    id: 'gift_perfect_match',
    text: '那份礼物刚好撞上了对方的喜好，连原本的陌生感都一下子淡了很多。',
    effects: { intimacy: 3, mood: 2 },
    tags: ['gift', 'surprise', 'outgoing'],
  },
  {
    id: 'doorstep_reluctance',
    text: '都到门口了，它们还忍不住回头看了彼此一眼，像在约定下次再见。',
    effects: { intimacy: 3, mood: 1 },
    tags: ['outgoing', 'soft', 'bond'],
  },
];
